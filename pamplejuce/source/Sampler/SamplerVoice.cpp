...
void SamplerVoice::prepare (double sr)
{
    sampleRate = sr > 0.0 ? sr : 44100.0;
    forceStop();
}

void SamplerVoice::noteOn (const SamplerZone* zone, int note, float vel)
{
    currentZone = zone;
    midiNote = note;
...
float SamplerVoice::getSampleAt (double pos) const noexcept
{
